...
//
// A COPY OF THE ONE IN MLambda.AI.Logic.Tests, because it is `internal` and each test assembly needs
// its own. Five lines is cheaper than a shared project to hold them.
